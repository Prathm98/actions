...
async function uploadToInstagram(captionText, ch, series = '') {
  ...
  form.append(
    'video_url',
    `https://raw.githubusercontent.com/Prathm98/actions/refs/heads/insta-db/content${series}/final${ch}.mp4`,
  )
